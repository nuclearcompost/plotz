package
{
	...
	//-----------------------
	//Purpose:				The internal workings of a menu that can hold items the player can purchase
	//
	//Properties:
	//	
	//Methods:
	//	
	//-----------------------
	public class BuyMenu extends InventoryMenu
	{
		// Constants //
		...
		public function BuyMenu(inventory:Inventory, gameController:GameController)
		{
		...
		public override function Paint():MovieClip
		{
			...
			for (var i:int = 0; i < _inventory.maxSize; i++)
			{
				...
				mcEvent.addEventListener(MouseEvent.CLICK, OnMenuSlotClick, false, 0, true);
		...
		private function OnMenuSlotClick(event:MouseEvent):void
		{
			...
			_gameController.OnBuyMenuSlotClick(this, event.currentTarget.slot);
		}
